...
",
            ...
            //Seed alignments
            modelBuilder.Entity<Alignment>().HasData(new Alignment[]
            {
                new Alignment {
                    Id = 1,
                    Name = "Lawful Good",
            ...
            {
                new Class { Id = 1, ClassName = "Sorcerer", HitDie = 8},
                new Class { Id = 2, ClassName = "Wizard", HitDie = 8},
                new Class { Id = 3, ClassName = "Bard", HitDie = 8},
                new Class { Id = 4, ClassName = "Cleric", HitDie = 8},
                new Class { Id = 5, ClassName = "Druid", HitDie = 8},
                new Class { Id = 6, ClassName = "Monk", HitDie = 8},
                new Class { Id = 7, ClassName = "Rogue", HitDie = 8},
                new Class { Id = 8, ClassName = "Warlock", HitDie = 8},
                new Class { Id = 9, ClassName = "Fighter", HitDie = 10},
                new Class { Id = 10, ClassName = "Ranger", HitDie = 10},
                new Class { Id = 11, ClassName = "Paladin", HitDie = 10},
                new Class { Id = 12, ClassName = "Barbarian", HitDie = 12}
            });

            //Seed Sub-classes
            modelBuilder.Entity<SubClass>().HasData(new SubClass[]
            {
                new SubClass {
                    Id = 1,
...
",
            ...
            //seed some starting items for initial character
            modelBuilder.Entity<CharacterItem>().HasData(new CharacterItem[]
            {
                new CharacterItem {
                    Id = 1,
                    ItemId = 2,
            ...
            //Seed ClassAbilities to assign specific abilities to specific classes
            modelBuilder.Entity<ClassAbility>().HasData(new ClassAbility[]
            {
                new ClassAbility { Id = 1, ClassId = 1, AbilityId = 105 },
                new ClassAbility { Id = 2, ClassId = 1, AbilityId = 106 },
                new ClassAbility { Id = 3, ClassId = 1, AbilityId = 107 },
                new ClassAbility { Id = 4, ClassId = 2, AbilityId = 105 },
                new ClassAbility { Id = 5, ClassId = 2, AbilityId = 106 },
                new ClassAbility { Id = 6, ClassId = 2, AbilityId = 107 },
                new ClassAbility { Id = 7, ClassId = 3, AbilityId = 102 },
                new ClassAbility { Id = 8, ClassId = 3, AbilityId = 107 },
                new ClassAbility { Id = 9, ClassId = 3, AbilityId = 108 },
                new ClassAbility { Id = 10, ClassId = 3, AbilityId = 109 },
                new ClassAbility { Id = 11, ClassId = 4, AbilityId = 100 },
                new ClassAbility { Id = 12, ClassId = 4, AbilityId = 101 },
                new ClassAbility { Id = 13, ClassId = 4, AbilityId = 102 },
                new ClassAbility { Id = 14, ClassId = 4, AbilityId = 103 },
                new ClassAbility { Id = 15, ClassId = 4, AbilityId = 104 },
                new ClassAbility { Id = 16, ClassId = 5, AbilityId = 102 },
                new ClassAbility { Id = 17, ClassId = 5, AbilityId = 105 },
                new ClassAbility { Id = 18, ClassId = 5, AbilityId = 110 },
                new ClassAbility { Id = 19, ClassId = 5, AbilityId = 111 },
                new ClassAbility { Id = 20, ClassId = 5, AbilityId = 122 },
                new ClassAbility { Id = 21, ClassId = 6, AbilityId = 102 },
                new ClassAbility { Id = 22, ClassId = 6, AbilityId = 121 },
                new ClassAbility { Id = 23, ClassId = 6, AbilityId = 107 },
                new ClassAbility { Id = 24, ClassId = 7, AbilityId = 112 },
                new ClassAbility { Id = 25, ClassId = 7, AbilityId = 113 },
                new ClassAbility { Id = 26, ClassId = 8, AbilityId = 114 },
                new ClassAbility { Id = 27, ClassId = 8, AbilityId = 115 },
                new ClassAbility { Id = 28, ClassId = 8, AbilityId = 116 },
                new ClassAbility { Id = 29, ClassId = 9, AbilityId = 117 },
                new ClassAbility { Id = 30, ClassId = 9, AbilityId = 118 },
                new ClassAbility { Id = 31, ClassId = 9, AbilityId = 119 },
                new ClassAbility { Id = 32, ClassId = 10, AbilityId = 120 },
                new ClassAbility { Id = 33, ClassId = 10, AbilityId = 121 },
                new ClassAbility { Id = 34, ClassId = 10, AbilityId = 122 },
                new ClassAbility { Id = 35, ClassId = 10, AbilityId = 110 },
                new ClassAbility { Id = 36, ClassId = 10, AbilityId = 111 },
                new ClassAbility { Id = 37, ClassId = 11, AbilityId = 123 },
                new ClassAbility { Id = 38, ClassId = 11, AbilityId = 124 },
                new ClassAbility { Id = 39, ClassId = 11, AbilityId = 125 },
                new ClassAbility { Id = 40, ClassId = 12, AbilityId = 126 },
                new ClassAbility { Id = 41, ClassId = 12, AbilityId = 127 },
                new ClassAbility { Id = 42, ClassId = 12, AbilityId = 128 }
            });


            //Configuring Character Abilities joining table 
            ...
            modelBuilder.Entity<CharacterAbility>()
                ...
                .HasForeignKey(ca => ca.AbilityId);  
                 ...
                 //Seed in abilities for initial characters 
            modelBuilder.Entity<CharacterAbility>().HasData(new CharacterAbility[]
            {
                new CharacterAbility { AbilityId = 101, CharacterId = 1 },
                new CharacterAbility { AbilityId = 100, CharacterId = 1 },
                new CharacterAbility { AbilityId = 102, CharacterId = 2 },
                new CharacterAbility { AbilityId = 107, CharacterId = 2 },
                new CharacterAbility { AbilityId = 108, CharacterId = 3 },
                new CharacterAbility { AbilityId = 109, CharacterId = 3 },
                new CharacterAbility { AbilityId = 126, CharacterId = 4 },
                new CharacterAbility { AbilityId = 127, CharacterId = 4 }
            });  


            //Configure Cascade Delete for Campaign and CampaignLogs as well as CharacterCampaign joining tables
            modelBuilder
                .Entity<CampaignLog>()
            ...
            modelBuilder
                .Entity<CharacterCampaign>()
                .HasOne(cc => cc.Campaign)
                .WithMany(c => c.CharacterCampaigns)
                .OnDelete(DeleteBehavior.Cascade);


            //Configure Cascade Delete for a Character and its CharacterCamapign joining table
            modelBuilder
                .Entity<CharacterCampaign>()
            ...
            //Configure Cascade Delete for a Character and its CharacterAbilties as well as CharacterItems
            modelBuilder
